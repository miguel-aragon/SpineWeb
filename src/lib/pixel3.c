...
void shell_07(int *shell_ind, int nx, int ny, int nz, int x_grid, int y_grid, int z_grid){
  int x00,x01,x02,x03,x04,x05,x06;
  int y00,y01,y02,y03,y04,y05,y06;
  int z00,z01,z02,z03,z04,z05,z06;
  
  //  X            Y            Z
  x00 = nx;    y00 = ny;    z00 = nz;
  x01 = nx-1;  y01 = ny;    z01 = nz;
  x02 = nx+1;  y02 = ny;    z02 = nz;
  x03 = nx;    y03 = ny-1;  z03 = nz;
  x04 = nx;    y04 = ny+1;  z04 = nz;
  x05 = nx;    y05 = ny;    z05 = nz-1;
  x06 = nx;    y06 = ny;    z06 = nz+1;

  //--- Periodic conditions
  if(nx == 0)        x01 = x_grid-1;
  if(nx == x_grid-1) x02 = 0;
  if(ny == 0)        y03 = y_grid-1;
  if(ny == y_grid-1) y04  = 0;
  if(nz == 0)        z05 = z_grid-1;
  if(nz == z_grid-1) z06 = 0;
