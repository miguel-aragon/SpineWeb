...
int main(int argc, char **argv)
{
  ...
  if (argc != 4) {
    printf("------------------------------------------ \n");
    printf("           watershed_flood_fix_spine_float \n");
    printf("\n");
    printf(" USAGE:\n");
    printf("     ./watershed_flood_fix_spine_float  watershed_raw.ivol density.fvol watershed.ivol \n");
    printf("\n");
    printf("NOTES: \n");
    printf("  - floating point input/output\n");
    printf("\n");
    printf("\n");
    printf("------------------------------------------ \n");
    exit(0); }
  ...
  //--- Read density field
  //====================================
  density = Read_DataCube_float(argv[2], &Header_Den);
  ...
  local_watershed_sort_float(density, water, boundaries, Header_Wat.sizeX,Header_Wat.sizeY,Header_Wat.sizeZ);
