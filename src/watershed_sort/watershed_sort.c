...
int main(int argc, char **argv)
{
  ...
  if (argc != 3)
    {
      printf("------------------------------------------ \n");
      printf("          watershed algorithm \n");
      printf("\n");
      printf(" Usage:\n");
      printf("     ./watershed_sort density.dvol watershed.ivol \n");
      printf("\n");
      printf("     This version reads a double datacube and outputs a long datacube\n");
      printf("\n");
      printf("\n");
      printf("------------------------------------------ \n"); 
      fflush(stdout);
  ...
  density = Read_DataCube_double(argv[1],&Header);
  ...
  //voids = watershed_sorted_int_27(density, Header.sizeX, Header.sizeY, Header.sizeZ);
  voids = watershed_sorted_int_07(density, Header.sizeX, Header.sizeY, Header.sizeZ);
