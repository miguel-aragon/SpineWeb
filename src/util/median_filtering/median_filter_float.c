...
int main(int argc, char **argv)
{
  ...
  if (argc != 4){
    printf("\nUsage:\n");
    printf(" median_filter input.fvol threshold_value output.fvol \n\n");
    exit(0);
  }
  ...
  read_volume_float(argv[1], &density, &sizeG, &sizeX, &sizeY, &sizeZ, &offsX, &offsY, &offsZ);
  ...
  write_volume_fouble(argv[3], density, sizeG, sizeX,sizeY,sizeZ, offsX,offsY,offsZ);
