...
#include "inc/count_adjacent_regions.h"
...
int main(int argc, char **argv)
{
  ...
  if (argc != 3) {
    ...
    printf("\n");
    printf(" Usage:\n");
    printf("     ./count_voxel_degree  volume.reg  volume.deg \n");
    printf("\n");
    printf("------------------------------------------ \n");
    exit(0); }
  ...
  spine = count_adjacent_regions(water, Header_Wat.sizeX,Header_Wat.sizeY,Header_Wat.sizeZ);
